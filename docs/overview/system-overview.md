...
Related: [Architecture Review](architecture-review.md) · [Backend Architecture](../backend/architecture.md) · [Frontend Overview](../frontend/overview.md) · [Gym Onboarding Flow](../features/gym-onboarding-flow.md)
